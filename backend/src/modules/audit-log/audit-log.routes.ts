...
router.get('/export', authorize({ resource: 'audit-log', action: 'read' }), auditView({ action: 'EXPORT_AUDIT_LOG', entity: 'AuditLog' }), auditLogController.exportCsv.bind(auditLogController));
