...
router.patch('/:id/approve', authorize({ resource: 'permission-request', action: 'update' }), validate(approvePermissionSchema), permissionRequestController.approve.bind(permissionRequestController));
router.patch('/:id/reject', authorize({ resource: 'permission-request', action: 'update' }), validate(approvePermissionSchema), permissionRequestController.reject.bind(permissionRequestController));
