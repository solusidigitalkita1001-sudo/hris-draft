...
import attendanceCorrectionRoutes from '@/modules/attendance/attendance-correction.routes';
...
app.use(`${apiPrefix}/attendance-corrections`, attendanceCorrectionRoutes);
